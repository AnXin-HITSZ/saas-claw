...
# 1a. 配置 pause 镜像（国内 ECS 无法拉 Docker Hub 的 pause 镜像，K3s 所有新 Pod 会卡在 ContainerCreating）
docker pull rancher/mirrored-pause:3.6
docker tag rancher/mirrored-pause:3.6 crpi-li78f6lp5zheaj11.cn-shenzhen.personal.cr.aliyuncs.com/saas-claw/mirrored-pause:3.6
docker login --username=AnXin_HITSZ crpi-li78f6lp5zheaj11.cn-shenzhen.personal.cr.aliyuncs.com
docker push crpi-li78f6lp5zheaj11.cn-shenzhen.personal.cr.aliyuncs.com/saas-claw/mirrored-pause:3.6
sudo tee -a /etc/rancher/k3s/config.yaml <<'EOF'
pause-image: crpi-li78f6lp5zheaj11.cn-shenzhen.personal.cr.aliyuncs.com/saas-claw/mirrored-pause:3.6
EOF
